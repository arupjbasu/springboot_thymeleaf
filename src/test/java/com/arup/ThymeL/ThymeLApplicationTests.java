package com.arup.ThymeL;
//package com.arup.ThymeL;
import com.arup.ThymeL.WelcomeController;
  ...
  class ThymeLApplicationTests {
    ...
    public void main() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("ARUP BASU")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, ARUP BASU")));
